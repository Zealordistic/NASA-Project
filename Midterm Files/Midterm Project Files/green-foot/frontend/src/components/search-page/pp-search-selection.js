...
const PPSearchSelection = ({onCheckClick}) => {
    const searchCheckClick = (event) => {
        onCheckClick(event.target.checked, event.target.name);
    }

    return (
        <div className="container-fluid" id="select-search">
                    ...
                    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                        ...
                        <div class="container text-center">
                            ...
                            <div className="row">
                                ...
                                <div className="col">
                                    <Checkbox value="Plant Code" callBackCheck={searchCheckClick}/>
                                </div>
                                <div className="col">
                                    <Checkbox value="Plant Type" callBackCheck={searchCheckClick}/>
                                </div>
                            </div>
                        </div> 
                        </div>
...
export default PPSearchSelection;